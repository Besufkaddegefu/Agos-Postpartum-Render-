...
async def d_step6(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if 'd_pkg' not in context.user_data:
        kb = [
            [InlineKeyboardButton("Hospital Decor - 10,000 ETB", callback_data='10k')],
            [InlineKeyboardButton("Home Decor - 15,000 ETB", callback_data='15k')],
            [InlineKeyboardButton("Deluxe Decor - 20,000 ETB", callback_data='20k')],
            [InlineKeyboardButton("Premium Decor- 25,000 ETB", callback_data='25k')],
            [InlineKeyboardButton("Special Decor - 48,000 ETB", callback_data='48k')],
